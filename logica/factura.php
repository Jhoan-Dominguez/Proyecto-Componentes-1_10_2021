...
private $facturaDAO;
    ...
    public function factura( $id_factura="",$id_reserva="",$id_usuario="",$fecha_pago="",$precio_total="",$servicios_total="" ) {
...
$this -> facturaDAO = new facturaDAO($this->id_factura,$this->id_reserva,$this->id_usuario,$this->fecha_pago,$this->precio_total,$this->servicios_total);
    }
    ...
    public function consultarTodos() {
        ...
        while( ($resultado = $this -> conexion -> extraer()) != null) {
            array_push($valoresRetornar, new factura( $resultado[0],$resultado[1],$resultado[2],$resultado[3],$resultado[4],$resultado[5] ));
        }
