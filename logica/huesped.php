...
private $huespedDAO;
    ...
    public function huesped( $id_huesped="",$id_reserva="",$nombre_huesped="",$apellido_huesped="" ) {
...
$this -> huespedDAO = new huespedDAO($this->id_huesped,$this->id_reserva,$this->nombre_huesped,$this->apellido_huesped);
    }
