...
private $servicioReservaDAO;
    ...
    public function servicioReserva( $id_servicioReserva="",$id_servicio="",$id_reserva="" ) {
        
        $this -> id_servicioReserva = $id_servicioReserva;
        $this -> id_servicio = $id_servicio;
        $this -> id_reserva = $id_reserva;
        $this -> conexion = new conexion();
        $this -> servicioReservaDAO = new servicioReservaDAO($this->id_servicioReserva,$this->id_servicio,$this->id_reserva);
    }
    ...
    public function consultarservicioReserva( $id_servicioReserva ){
            ...
            while( ($resultado = $this -> conexion -> extraer()) != null) {
                array_push($valoresRetornar, new servicioReserva( $resultado[0],$resultado[1],$resultado[2] ));
            }
