...
public function huespedDAO( $id_huesped="",$id_reserva="",$nombre_huesped="",$apellido_huesped="",$edad_huesped="" ) {
...
return "
insert into huesped (id_reserva,nombre_huesped,apellido_huesped,edad_huesped)
values (
 '" .$this -> id_reserva. "', 
 '" .$this -> nombre_huesped. "', 
