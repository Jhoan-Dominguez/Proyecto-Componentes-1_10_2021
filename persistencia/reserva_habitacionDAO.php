...
public function reserva_habitacionDAO( $id_reserva_habitacion="",$id_habitacion="",$id_reserva="",$cant_reserva_habitacion="",$precio_reserva_habitacion="" ) {
...
return "
insert into reserva_habitacion (id_habitacion,id_reserva,cant_reserva_habitacion,precio_reserva_habitacion)
values (
 '" .$this -> id_habitacion. "',
 '" .$this -> id_reserva. "',
